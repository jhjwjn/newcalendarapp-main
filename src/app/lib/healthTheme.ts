...
export function getHealthTheme(settings: HealthSettings): HealthTheme {
  ...
  return {
    ...
    shellBackground: 'rgba(255, 255, 255, 0.68)',
    shellBorder: 'rgba(255, 255, 255, 0.6)',
    shellShadow: `0 28px 80px ${colors.primary}16`,
    navBackground: 'rgba(15, 23, 42, 0.04)',
    navActiveBackground: `linear-gradient(135deg, ${colors.primary}24 0%, ${colors.tertiary}18 52%, ${colors.accent1}16 100%)`,
    navActiveText: '#0F172A',
    navIdleText: '#475569',
    buttonGradient: `linear-gradient(135deg, ${colors.primary} 0%, ${colors.tertiary} 55%, ${colors.accent1} 100%)`,
    buttonShadow: `0 18px 34px ${colors.primary}24, inset 0 1px 0 rgba(255,255,255,0.34)`,
